...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.92\linewidth]{../../outputs/visualizations/model_training_summary/model_performance.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.92\linewidth]{../../outputs/visualizations/model_training_summary/prediction_error_profile.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.92\linewidth]{../../outputs/visualizations/model_training_summary/global_explanation_map.png}
